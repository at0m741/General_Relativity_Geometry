...
void calculate_riemann(double Gamma[NDIM][NDIM][NDIM], double Gamma_plus_h[NDIM][NDIM][NDIM],\
		double Gamma_minus_h[NDIM][NDIM][NDIM], double Riemann[NDIM][NDIM][NDIM][NDIM], double h, double X[NDIM]);
